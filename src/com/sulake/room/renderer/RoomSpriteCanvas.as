package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1523:int = 50;
      
      private static const const_1068:Number = 60;
      
      private static const const_1524:Number = 50;
      ...
      private var var_3144:int = 0;
      
      private var var_272:Sprite;
      
      private var var_153:Sprite;
      
      private var var_110:Sprite;
      ...
      private var var_658:RoomObjectCache;
      
      private var var_553:Array;
      
      private var var_659:Array;
      
      private var var_1513:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2530:Number = -1.0E7;
      
      private var var_2527:Number = -1.0E7;
      ...
      private var var_3108:Boolean = false;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_272 = new Sprite();
         this.var_272.mouseEnabled = false;
         this.var_110 = new Sprite();
         this.var_110.name = "canvas";
         this.var_110.mouseEnabled = false;
         this.var_272.addChild(this.var_110);
         this.var_110.mouseEnabled = true;
         this.var_110.doubleClickEnabled = true;
         this.var_110.addEventListener(MouseEvent.CLICK,this.clickHandler);
         this.var_110.addEventListener(MouseEvent.DOUBLE_CLICK,this.clickHandler);
         ...
         this.var_658 = new RoomObjectCache(_loc6_);
         this.var_904 = new ColorTransform();
         this.var_656 = new Matrix();
      ...
      {
         this.var_554.x -= param1 - this.var_660;
         this.var_660 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_554.y -= param1 - this.var_661;
         this.var_661 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1018 = true;
            if(this.var_153 != null && !this.var_272.contains(this.var_153))
            {
               this.var_272.addChild(this.var_153);
               this.var_110.mask = this.var_153;
            }
         }
         else if(!param1 && this.var_1018)
         {
            this.var_1018 = false;
            if(this.var_153 != null && this.var_272.contains(this.var_153))
            {
               this.var_272.removeChild(this.var_153);
               this.var_110.mask = null;
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_272.numChildren > 0)
            {
               this.var_272.removeChildAt(0);
            }
            this.var_272 = null;
         }
         this.var_110 = null;
         ...
         if(this.var_659 != null)
         {
            ...
            {
               this.cleanSprite(this.var_659[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_659 = [];
         }
      ...
      {
         this.var_658.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1875 = !this.var_1875;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1512)
         {
            return;
         }
         ...
         if(this.var_551 != this.var_2525 || this.var_552 != this.var_2526)
         {
            _loc8_ = true;
         }
         if(this.var_110.x != this.var_660 || this.var_110.y != this.var_661)
         {
            this.var_110.x = this.var_660;
            this.var_110.y = this.var_661;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2525 = this.var_551;
         this.var_2526 = this.var_552;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1512 > 0)
         {
            _loc2_ = param1 - this.var_1512;
            if(_loc2_ > const_1068 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2529 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_801;
               if(this.var_801 == const_390 + 1)
               {
                  this.var_588 = _loc2_;
                  this.var_1874 = this.var_2528;
               }
               else if(this.var_801 > const_390 + 1)
               {
                  _loc3_ = Number(this.var_801 - const_390);
                  this.var_588 = this.var_588 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1874 = this.var_1874 * (_loc3_ - 1) / _loc3_ + Number(this.var_2528) / _loc3_;
                  if(this.var_801 > const_390 + const_1523)
                  {
                     this.var_801 = const_390;
                     if(!this.var_1232 && this.var_588 > const_1068)
                     {
                        this.var_1232 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1232 && this.var_588 < const_1524)
                     {
                        this.var_1232 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_658.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_658.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1875 && this.var_1232);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_660;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_661;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_660;
                     _loc17_.y = _loc20_ - this.var_661;
      ...
      {
         if(param1 < this.var_551 && param1 + param3 >= 0 && (param2 < this.var_552 && param2 + param4 >= 0))
         {
            if(!this.var_3108)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_551)
         {
            param3 -= this.var_551 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_552)
         {
            param4 -= this.var_552 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2531)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1011)
         {
            return null;
         }
         return this.var_110.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_659.length > 0)
         {
            _loc3_ = this.var_659.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1011)
         {
            this.var_110.addChild(_loc3_);
            ++this.var_1011;
         }
         else
         {
            this.var_110.addChildAt(_loc3_,param2);
         }
         ++this.var_802;
      }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(_loc4_ != null)
         {
            if(_loc4_.varyingDepth != _loc3_.varyingDepth)
            {
               if(_loc4_.varyingDepth && !_loc3_.varyingDepth)
               {
                  this.var_110.removeChildAt(param1);
                  this.var_659.push(_loc4_);
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_802 || this.var_802 == 0)
         {
            _loc4_ = this.var_1011 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_656.identity();
            if(flipH)
            {
               this.var_656.scale(-1,1);
               this.var_656.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_656.scale(1,-1);
               this.var_656.translate(0,data.height);
            }
            finalData.draw(data,this.var_656);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_692);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         this.var_1873 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1233;
         return this.var_1873;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_551 / 2;
         var _loc12_:Number = param2 - this.var_552 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1872,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_657.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_657.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2530 || param2 != this.var_2527)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_657.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_657.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_376 != null && param1 != null)
         {
            this.var_376.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_376 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_376.length)
         {
            _loc2_ = this.var_376.getKey(_loc1_);
            _loc3_ = this.var_376.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1513.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
