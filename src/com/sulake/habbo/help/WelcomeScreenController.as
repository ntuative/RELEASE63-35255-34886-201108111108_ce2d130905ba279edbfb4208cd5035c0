   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function dispose() : void
      {
         if(this.var_197)
         {
            ...
            this.var_197.toolbar.events.removeEventListener(HabboToolbarEvent.const_48,this.onToolbarClicked);
            this.var_197 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_70 = param1;
         this.var_197.toolbar.events.addEventListener(HabboToolbarEvent.const_48,this.onToolbarClicked);
         ...
         this.var_212.y = this.var_197.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
      ...
      private function initializeWindow() : void
      {
         ...
         _loc4_.content.setParamFlag(WindowParam.const_308,false);
         _loc4_.height -= 20;
