package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1835:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this.var_130.add(HabboHelpViewEnum.const_1816,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_228,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_527,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_349,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_313,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_425,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_766,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_261,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_130.add(HabboHelpViewEnum.const_1433,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_130.add(HabboHelpViewEnum.const_1355,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_753,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_130.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_130.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_542.length == 0 || param1 != this.var_372)
            {
               this.var_542.push(this.var_372);
            }
         }
         this.var_372 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_261:
               ...
               break;
            case CallForHelpResultEnum.const_1271:
               this.showUI(HabboHelpViewEnum.const_1355);
               break;
            case CallForHelpResultEnum.const_1381:
               this.showUI(HabboHelpViewEnum.const_1433);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_130.getValue(HabboHelpViewEnum.const_228) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_626));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_130.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_130.getValue(this.var_372);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2489 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2490;
         this._window.width = _loc1_.width + this.var_2489;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_372 == HabboHelpViewEnum.const_228)
         {
            return;
         }
         if(this.var_645.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_645.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_645[1],this.var_645[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_645[0],this.var_645[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_372 == HabboHelpViewEnum.const_228 || this.var_542.length == 0)
         {
            return;
         }
         if(this.var_373 == null)
