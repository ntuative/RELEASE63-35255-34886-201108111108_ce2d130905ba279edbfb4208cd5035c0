package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2414:String = "hd-99999-99999";
      ...
      private var var_344:PetDataManager;
      
      private var var_893:PaletteManager;
      
      private var var_701:String;
      
      private var var_345:Map;
      
      private var var_259:AvatarAssetDownloadManager;
      
      private var var_2108:AvatarFigureContainer;
      
      private var var_2963:Boolean = false;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_701 = RenderMode.const_2055;
         this.var_345 = new Map();
         this.var_123 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_140,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_123.add(AvatarType.const_140,_loc4_);
         ...
         this.var_123.add(AvatarType.const_55,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_344 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_893 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_344.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_259)
         {
            this.var_259.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_344.init();
         this.var_893.init();
         _loc2_ = this.var_123.getValue(AvatarType.const_140) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_123.getValue(AvatarType.const_55) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_123.getValue(AvatarType.const_140) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1295,this.onFigureDataDownloadDone);
               if(this.var_259 == null)
               {
                  ...
                  this.var_259 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_259.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_963)
         {
            if(this.var_2963 && this.var_2964 && this.var_2962)
            {
               this.var_963 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_259.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_259.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_123.getValue(AvatarType.const_140) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_259.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2108)
         {
            this.var_2108 = new AvatarFigureContainer(this.const_2414);
         }
         this.var_259.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2108,param2);
      }
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_344.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_2062)
         {
            _loc6_ = !this.var_344.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_344.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_123.getValue(AvatarType.const_55) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_344.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_123.getValue(AvatarType.const_55);
      ...
      {
         var _loc3_:AvatarStructure = this.var_123.getValue(AvatarType.const_140) as AvatarStructure;
      ...
      {
         return this.var_344 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_140:
               _loc3_ = this.var_123.getValue(AvatarType.const_140) as AvatarStructure;
               break;
            case AvatarType.const_55:
               _loc3_ = this.var_123.getValue(AvatarType.const_55) as AvatarStructure;
               break;
            default:
