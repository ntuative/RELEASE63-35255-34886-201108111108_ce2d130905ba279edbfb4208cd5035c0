package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_300)
         {
            for each(_loc2_ in this.var_300 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_261 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_1117 >= 0 && this._parts.length > this.var_1117)
         {
            _loc2_ = this._parts[this.var_1117];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_261[param2],param2);
         this.var_261[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_300 || this.var_300.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_300[0] as Array;
         ...
         {
            _loc7_ = this.var_300[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_261[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_261[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_261[param1])
         {
            return null;
         }
         return _loc2_[this.var_261[param1]] as AvatarEditorGridColorItem;
      }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         return this.var_300[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_1117] as AvatarEditorGridPartItem;
      }
