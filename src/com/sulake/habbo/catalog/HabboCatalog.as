package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_720:uint = 1;
      ...
      private var var_231:CatalogViewer;
      
      private var var_257:ICatalogNavigator;
      
      private var var_118:Purse;
      
      private var var_106:RecyclerLogic;
      
      private var var_164:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_208:PurchaseConfirmationDialog;
      ...
      private var var_2951:Boolean = true;
      
      private var var_2091:Boolean = false;
      
      private var var_2950:GiftWrappingConfiguration;
      
      private var var_1340:ClubGiftController;
      
      private var var_594:ClubBuyController;
      
      private var var_880:ClubExtendController;
      
      private var var_877:Map;
      
      private var var_1341:Boolean = false;
      
      private var var_878:IPurchasableOffer;
      
      private var var_1653:IDragAndDropDoneReceiver;
      ...
      private const const_2119:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_84,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1864);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_414.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_118.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_118.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_208 == null || this.var_208.disposed)
            {
               this.var_208 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_208.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_594.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2952 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_414.loadProductData(this);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_783 || !this.var_257 || !this.var_257.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1103 = -1;
            this.var_879 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_257.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_414.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_414.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_65)
         {
            _loc3_ = this.var_414.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_877.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_118.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_118.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
         if(!this.var_118.hasClubLeft)
         {
         ...
         else
         {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_118.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_118.clubPeriods));
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_231.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_257 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_231 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_231.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_720) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2119;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_277,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_77:
               this.var_2091 = param1.session.isPrivateRoom;
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_164 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1340 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_594 == null)
         {
            this.var_594 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_880 == null)
         {
            this.var_880 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_231 != null)
         {
            this.var_231.catalogWindowClosed();
         }
         if(this.var_106 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_106.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1652 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_257.buildCatalogIndex(_loc2_);
         if(this.var_879 && this.var_879 != "")
         {
            this.var_257.openPage(this.var_879);
            this.var_879 = "";
            this.var_1103 = -1;
         }
         else if(this.var_1103 > -1)
         {
            this.var_257.openPageById(this.var_1103,this.var_2092);
            this.var_1103 = -1;
            this.var_2092 = -1;
            this.var_879 = "";
         }
         else if(this.var_1652 && this.var_2952)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_257.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1959));
         }
         else
         {
            this.var_257.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_231.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_231 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_231.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_118.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2953 && this._soundManager != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_134,this.var_118.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_118.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2951 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1269);
         }
         this.var_2951 = false;
         if(this._chargeConfirmationDialog != null && !this._chargeConfirmationDialog.disposed)
         {
         ...
         if(_loc2_.type == ActivityPointTypeEnum.const_1022)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_118.activityPoints = _loc2_.points;
         this.updatePurse();
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_118.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_118.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_118.isVIP = _loc2_.isVIP;
         this.var_118.pastClubDays = _loc2_.pastClubDays;
         this.var_118.pastVipDays = _loc2_.pastVipDays;
         this.var_118.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1278 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1340.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_164 != null)
         {
            this.var_164.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_164 != null)
         {
            this.var_164.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_164 != null)
         {
            this.var_164.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2950 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_208 != null)
         {
            this.var_208.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_164.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_877.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_877.add(_loc2_.productCode,_loc3_.slice());
            this.var_231.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_217);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_221);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_236);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1341 && param1.type == RoomEngineObjectEvent.const_163)
         {
            this.resetPlacedOfferData(true);
            if(this.var_878 == null || this.var_878.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_878.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_64 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_878);
            _loc5_ = this.var_1653;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_370,0.5);
            }
         }
      }
            ...
            if(this.var_64.roomCategory == this._roomEngine.activeRoomCategory && this.var_64.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_332:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_221);
                  ...
                  case FurniCategory.const_379:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_217);
                  ...
                  case FurniCategory.const_348:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_236);
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_720);
            if(_loc1_ != null)
            {
