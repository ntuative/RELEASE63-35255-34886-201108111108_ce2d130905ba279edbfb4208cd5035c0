package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_528:IDisplayObjectWrapper;
      
      private var var_1755:Point;
      
      private var var_529:IItemGridWindow;
      
      private var var_1459:IScrollbarWindow;
      
      protected var var_2044:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_962 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1178 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_194 != null)
         {
            ...
            this.var_528 = this.var_194.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_528 != null && _loc3_ != null)
            {
               this.var_194.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_528.width,this.var_528.height);
               if(_loc4_ != null)
               {
                  this.var_528.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1755 = new Point(this.var_97.x,this.var_97.y);
         this.var_529 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1459 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_529 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_2044 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_529 != null)
         {
            this.var_529.visible = false;
            this.var_529.destroyGridItems();
         }
         ...
         this.var_962.text = _loc4_;
         this.var_1178.text = _loc5_;
         this.var_962.height = this.var_962.textHeight + 5;
         this.var_1178.y = this.var_962.y + this.var_962.height;
         this.var_1178.height = Math.max(130,this.var_1178.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_623:
                  _loc6_ = this._bundlePreview.clone();
                  if(this.var_529 != null)
                  {
                     this.var_529.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_529,this.var_1459,this.var_2044);
                     this.var_529.scrollV = 0;
                  }
                  if(this.var_194 != null)
                  {
                     this.var_194.visible = false;
               ...
               case Offer.const_403:
                  ...
                  if(this.var_194 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_71 || _loc9_.productType == ProductTypeEnum.const_65 || _loc9_.productType == ProductTypeEnum.const_199)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_71:
                        if(_loc8_ != null && this.var_528 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_380,AvatarAction.const_579);
                                 _loc18_.appendAction(AvatarAction.const_357,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2319)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2319 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_97 != null && true)
         {
            ...
            this.var_97.x = this.var_1755.x;
            this.var_97.y = this.var_1755.y;
            if(param3 != null)
            {
