package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_957:int = 0;
      
      protected var var_768:BitmapData;
      ...
      protected var var_3098:BitmapData;
      
      private var var_1695:Boolean;
      
      private const const_2144:Number = 1;
      
      private const const_2143:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2302 == FurniModelCategory.const_38)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_2225));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2276);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function method_1() : IItem
      {
         var _loc1_:* = null;
         if(this._items.length > 0)
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_834)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2143;
               _loc1_.blend = this.const_2143;
            }
            else
            {
               this._window.blend = this.const_2144;
               _loc1_.blend = this.const_2144;
            }
         }
         this.var_1642.color = !!this.var_1695 ? uint(const_1681) : uint(const_1680);
         this.var_2924.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2301 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3098;
               _loc5_.visible = true;
            }
            else
            {
