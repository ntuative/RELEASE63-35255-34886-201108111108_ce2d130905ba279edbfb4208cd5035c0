package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1502:int = 100;
      ...
      private var var_1494:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_458 = [];
         this.var_459 = [];
         this.var_649 = new Timer(const_1502,1);
         ...
         this.var_2502 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_38)
            {
               if(this.var_1494 == null)
               {
                  this.var_1494 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1494;
            }
            else
            {
         ...
         this.var_26.setInventoryCategoryInit(InventoryCategory.const_74);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_379)
         {
         ...
         else if(param3 == FurniCategory.const_348)
         {
         ...
         if(this.var_790 == null)
         {
            this.var_790 = this._windowManager.buildFromXML(this.var_2502) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_790.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_790.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_38,const_44];
         var _loc5_:int = 0;
      ...
      {
         if(param1 == InventoryCategory.const_74 && this.var_26.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_44:
                  ...
                  break;
               case const_256:
                  this.var_26.toggleInventoryPage(InventoryCategory.const_138);
            }
         }
      }
      ...
      {
         this.var_2503 = getTimer();
         this.switchCategory(const_256);
      }
      ...
      {
         this.var_26.checkCategoryInitilization(InventoryCategory.const_418);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_38,const_44];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_38,const_44];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_648.add(const_38,new Array());
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_38;
            _loc5_ = this.var_458.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_44;
            _loc5_ = this.var_459.indexOf(param1.ref) > -1;
         }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_256)
            {
      ...
      {
         return getTimer() < this.var_2503 + const_1501;
      }
      ...
      {
         return this.var_26.getSubCategoryViewId() == InventorySubCategory.const_326;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         var _loc3_:IItem = _loc2_.method_1();
         if(_loc3_ == null)
         {
            return false;
         }
         if(_loc3_.category == FurniCategory.const_332 || _loc3_.category == FurniCategory.const_379 || _loc3_.category == FurniCategory.const_348)
         {
            if(param1)
            {
               return false;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_458.indexOf(_loc2_) == -1)
            {
               this.var_458.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_459.indexOf(_loc2_) == -1)
            {
               this.var_459.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_463:
               return this.var_458.length;
            case UnseenItemCategoryEnum.const_453:
               return this.var_459.length;
            default:
               return this.var_458.length + this.var_459.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_44:
               if(this.var_459 && this.var_459.length > 0)
               {
               ...
               break;
            case const_38:
               if(this.var_458 && this.var_458.length > 0)
               {
