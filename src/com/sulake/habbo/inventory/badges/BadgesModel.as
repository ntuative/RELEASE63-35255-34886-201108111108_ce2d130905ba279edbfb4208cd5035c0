package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_2052:int = -1;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_414 = param5;
         this.var_414.events.addEventListener(BadgeImageReadyEvent.const_136,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_414.events.removeEventListener(BadgeImageReadyEvent.const_136,this.onBadgeImageReady);
            this.var_414 = null;
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1310.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_709.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_414.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_253.unshift(_loc11_);
            }
            else
            {
               this.var_253.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_253.length)
         {
            _loc3_ = this.var_253[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_615);
      ...
      {
         return this.getItemInIndex(param1,const_615);
      }
      ...
      {
         if(param1 == InventoryCategory.const_293 && this.var_26.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_709.indexOf(_loc2_) == -1)
            {
               this.var_709.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_709 && this.var_709.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1372));
            this.var_709 = [];
