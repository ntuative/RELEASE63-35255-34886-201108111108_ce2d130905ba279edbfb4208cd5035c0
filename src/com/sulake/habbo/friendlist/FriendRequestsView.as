package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2140:String = "no_reqs_info";
      ...
      {
         this.var_2155 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2156 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2156.procedure = this.onDismissAllButtonClick;
         this.var_2155.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_424;
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_424 && _loc2_.state != FriendRequest.const_428)
            {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_428;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_224,param1));
         }
      }
      ...
      public function declineAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_424 && _loc2_.state != FriendRequest.const_428)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_224,_loc2_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2155,_loc1_);
         this.setEnabled(this.var_2156,_loc1_);
      }
