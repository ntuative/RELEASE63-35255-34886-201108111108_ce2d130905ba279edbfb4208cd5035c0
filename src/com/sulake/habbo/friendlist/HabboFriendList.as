package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_193:String = "face";
      ...
      private var var_2457:FriendListLookAndFeel;
      
      private var var_484:FriendListTabs;
      ...
      private var var_1811:AvatarSearchResults;
      ...
      {
         this.var_2457 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_119 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1811 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_639.stop();
            this.var_639.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_639 = null;
         }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_361,HabboWindowStyle.const_45,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         this.var_1027 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_1210,this.getText("friendlist.friends")));
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_435,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_119.addFriend(new Friend(_loc4_));
         }
         this.var_484 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_639)
         {
            this.var_639 = new Timer(120000);
            this.var_639.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_639.start();
         }
         ...
         {
            _loc5_ = this.var_119.findCategory(FriendCategory.const_435);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_484.findTab(FriendListTab.const_90).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_484.findTab(FriendListTab.const_90);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1811.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_484.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_484.findTab(FriendListTab.const_90);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_782 || !this.var_122)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_782.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_35))
         {
            _loc2_ = this.var_122.vipLimit;
         }
         else if(this.var_782.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_33))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_193) as IBitmapWrapperWindow;
