package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2364:int = "F".charCodeAt(0);
      
      public static const const_2221:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1123 = param1.gender;
         this.var_777 = param1.online;
         this.var_1814 = param1.followingAllowed && param1.online;
         this.var_727 = param1.figure;
         this.var_1815 = param1.motto;
         this.var_1778 = param1.lastAccess;
         this.var_1713 = param1.categoryId;
