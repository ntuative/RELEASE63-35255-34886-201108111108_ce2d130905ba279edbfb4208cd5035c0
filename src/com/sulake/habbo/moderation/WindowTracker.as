package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1980:int = 2;
      
      public static const const_1259:int = 3;
      
      public static const const_811:int = 4;
      
      public static const const_1215:int = 5;
      
      public static const const_1903:int = 6;
      
      public static const const_2014:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_2068:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_1930[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1930[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
