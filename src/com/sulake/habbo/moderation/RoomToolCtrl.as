package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1608:ICheckBoxWindow;
      
      private var var_1607:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_429));
         Logger.log("BEGINNING TO SHOW: " + this.var_429);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_2068;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_429);
         if(param1.flatId != this.var_429)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_429);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1608 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1607 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_811,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1839,_loc2_,this.var_533.text,"",""));
         if(this.var_1608.isSelected || this.var_1607.isSelected || this.var_1069.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1608.isSelected,this.var_1607.isSelected,this.var_1069.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_2058);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1236.selection];
         if(_loc3_ != null)
         {
            this.var_686 = false;
