package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1126:TagListRenderer;
      
      private var var_161:IBorderWindow;
      
      private var var_2826:int;
      
      private var var_2825:Boolean = true;
      
      private const const_710:int = 5;
      
      private const const_2127:int = 3;
      
      private const const_1616:int = 11184810;
      
      private const const_1617:int = 16777215;
      
      private const const_2399:int = 2000;
      
      private const const_2126:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1126 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2825 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.var_161.findChildByName("name").caption = "${group.badgepopup.caption}";
         this.var_161.findChildByName("description").caption = "${group.badgepopup.body}";
         var _loc3_:Rectangle = new Rectangle();
         _loc2_.getGlobalRectangle(_loc3_);
         this.var_161.x = _loc3_.left - this.var_161.width;
         this.var_161.y = _loc3_.top + (_loc3_.height - this.var_161.height) / 2;
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_710;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc5_.textColor = this.const_1617;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_710,this.const_2126);
         _loc5_.height = Math.max(_loc5_.height,this.const_2125);
         _loc3_.height = _loc5_.height + this.const_2127;
         if(param2)
         {
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1126.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2826 > this.const_2399 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2826 = _loc6_;
               _loc3_.textColor = this.const_1617;
            }
         }
         else
         {
         ...
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_710,this.const_2126);
         _loc3_.height = Math.max(_loc3_.height,this.const_2125);
         _loc2_.height = _loc3_.height + this.const_2127;
      }
