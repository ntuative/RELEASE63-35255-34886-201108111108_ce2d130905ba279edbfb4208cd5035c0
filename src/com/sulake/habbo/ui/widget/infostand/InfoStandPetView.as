package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1676:int = 162;
      
      private static const const_1665:int = 16;
      
      private static const const_715:int = 4;
      
      private static const const_1664:uint = 14342874;
      
      private static const const_1667:uint = 3815994;
      
      private static const const_1666:uint = 2085362;
      
      private static const const_1671:uint = 39616;
      
      private static const const_1673:uint = 10513106;
      
      private static const const_1677:uint = 8734654;
      
      private static const const_1672:uint = 9094430;
      
      private static const const_1670:uint = 6200576;
      
      private static const const_1674:String = "happiness";
      
      private static const const_1675:String = "experience";
      
      private static const const_1669:String = "energy";
      ...
      private var var_229:PetCommandTool;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1674,param1.nutrition,param1.nutritionMax,const_1671,const_1666);
         this.updateStateElement(const_1675,param1.experience,param1.experienceMax,const_1677,const_1673);
         this.updateStateElement(const_1669,param1.energy,param1.energyMax,const_1670,const_1672);
         ...
         if(this.var_229 && this.var_229.isVisible() && param1.isOwnPet)
         {
            this.var_229.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_229.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1676,const_1665,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1664);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1667);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_715,_loc7_.width - 2,_loc7_.height - 2 - const_715);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_715);
      ...
      private function openTrainView() : void
      {
         if(this.var_229 == null)
         {
            this.var_229 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_565) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_229.showWindow(true);
            this.var_229.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_229 && this.var_229.getPetId() == this.var_565)
               {
                  this.var_229.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1823,true);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1139 + const_1138;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1138;
            }
         }
