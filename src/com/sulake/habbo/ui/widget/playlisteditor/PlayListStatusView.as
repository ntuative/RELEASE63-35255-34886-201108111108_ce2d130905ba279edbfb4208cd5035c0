package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_790:String = "PLSV_ADD_SONGS";
      
      public static const const_1386:String = "PLSV_START_PLAYBACK";
      
      public static const const_633:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_633)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_511[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_511[const_790];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_511.add(const_633,_loc1_);
