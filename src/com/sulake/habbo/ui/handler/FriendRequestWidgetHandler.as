package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_1018);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_945);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_745);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_1018:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_945:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_745:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_93);
         _loc1_.push(FriendRequestEvent.const_58);
         _loc1_.push(FriendRequestEvent.const_224);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_93:
            ...
            case FriendRequestEvent.const_224:
