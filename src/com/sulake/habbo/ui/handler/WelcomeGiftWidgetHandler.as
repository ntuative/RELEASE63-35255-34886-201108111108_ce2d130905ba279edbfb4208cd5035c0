package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_658;
      }
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_853 = [];
         this.var_853.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_853.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_853)
         {
            return;
         }
         for each(_loc1_ in this.var_853)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_915);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_820);
         return _loc1_;
      }
