package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1630:int = 2;
      ...
      private var var_2064:TriggerConfs;
      
      private var var_2063:ActionTypes;
      
      private var var_2062:ConditionTypes;
      
      private var var_294:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_866:RoomObjectHightLighter;
      
      private var var_197:UserDefinedRoomEventsHelp;
      
      private var var_1328:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2064 = new TriggerConfs();
         this.var_2063 = new ActionTypes();
         this.var_2062 = new ConditionTypes();
         this.var_294 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_866 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_294[param1];
            this.var_866.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_294[param1] = param2;
            this.var_866.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1328 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1328.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1328.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_866.hideAll(this.var_294);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1328.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1630) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1630 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2064);
         this.refreshConfigureElement(this.var_2063);
         this.refreshConfigureElement(this.var_2062);
