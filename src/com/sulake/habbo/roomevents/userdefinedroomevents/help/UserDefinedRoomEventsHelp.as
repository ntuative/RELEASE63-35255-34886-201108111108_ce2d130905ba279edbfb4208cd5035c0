package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_2046:IWindowContainer;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2046 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1320 = this.var_2046.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1320)
         {
            this.var_1320.procedure = this.onButtonClick;
         }
         this.var_1319 = this.var_2046.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1319)
         {
            this.var_1319.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_293 >= this.var_77.length - 1)
         {
            this.var_1319.disable();
         }
         else
         {
            this.var_1319.enable();
         }
         if(this.var_293 <= 0)
         {
      ...
      {
         ++this.var_293;
         this.var_293 = Math.min(this.var_293,this.var_77.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_293;
         this.var_293 = Math.max(this.var_293,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_77[this.var_293][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_77[this.var_293][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_77[this.var_293][1]).value;
