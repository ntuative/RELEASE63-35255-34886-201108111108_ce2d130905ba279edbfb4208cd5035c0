package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1475:int = 5;
      
      private static const const_1476:int = 800;
      
      private static const const_1473:int = 15;
      ...
      private var var_1180:QuestController;
      
      private var var_632:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1180 = new QuestController(this);
         this.var_632 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1475);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_414.events.removeEventListener(BadgeImageReadyEvent.const_136,this.var_632.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_414.events.addEventListener(BadgeImageReadyEvent.const_136,this.var_632.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_1180.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_632.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1180.questTracker.isVisible();
      }
