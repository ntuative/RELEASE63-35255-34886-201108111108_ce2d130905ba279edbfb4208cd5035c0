      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc13_ == 1)
            {
               ...
               _loc14_.userType = RoomObjectTypeEnum.const_137;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_237;
               _loc14_.figure = _loc7_;
               _loc14_.webID = _loc4_;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_571;
               ...
               _loc14_.sex = UserMessageData.const_1263;
            }
            _loc3_++;
         }
         return true;
