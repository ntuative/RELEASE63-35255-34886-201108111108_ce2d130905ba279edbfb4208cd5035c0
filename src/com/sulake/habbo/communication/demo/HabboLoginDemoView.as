package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_967:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_138.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_194,HabboWindowStyle.const_45,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2116,"/");
         if(_loc5_ != null)
         {
         ...
         if(this.var_138.habboConfiguration && this.var_138.habboConfiguration.getKey("try.existing.session","false") == "true")
         {
            ...
            this.windowEventProcessor(WindowEvent.allocate(WindowEvent.const_146,this._window,null,false));
         }
      }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2116,"/");
         ...
         {
            dispatchEvent(new Event(const_967));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_162.removeEventListener(SSOTicket.const_415,this.onParsedTicketSuccess);
            this.var_162.removeEventListener(SSOTicket.const_331,this.onParsedTicketFailure);
            this.var_162 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_162 = new SSOTicket(this.var_138.assets,_loc3_,_loc2_,param1);
         this.var_162.addEventListener(SSOTicket.const_415,this.onParsedTicketSuccess);
         this.var_162.addEventListener(SSOTicket.const_331,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_162.ticket);
         Logger.log("Has Facebook: " + this.var_162.isFacebookUser);
         if(this.var_162.isFacebookUser)
         {
            this.var_138.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_138.flashClientUrl = this.var_162.flashClientUrl;
         this.var_138.ssoTicket = this.var_162.ticket;
         this.var_162.removeEventListener(SSOTicket.const_415,this.onParsedTicketSuccess);
         this.var_162.removeEventListener(SSOTicket.const_331,this.onParsedTicketFailure);
         this.var_162 = null;
         dispatchEvent(new Event(const_967));
