package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1723:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1724:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_190:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3134 = new Array();
         this.var_190 = this.profiler;
         this._windowManager = param2;
         this.var_1038 = param3;
         var _loc4_:ByteArray = new var_1723() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_190)
         {
            this.var_190.removeStopEventListener(this.refresh);
            this.var_190 = null;
         }
         if(!this.var_190 && param1)
         {
            this.var_190 = param1;
            this.var_190.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_558)
            {
               this.var_2231 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_190.getProfilerAgentsInArray();
         ...
         if(this.var_2231)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_190.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_190.numBitmapAssetInstances + " / " + this.var_190.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_1038.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_190.numTrackedBitmapDataInstances + " / " + this.var_190.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1724() as ByteArray;
