package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1685:String = "_SELECTOR";
      
      private static const const_1686:String = "_CONTENT";
       
      
      protected var var_1170:ITabSelectorWindow;
      
      protected var var_2296:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1170 = findChildByTag(const_1685) as ITabSelectorWindow;
            if(this.var_1170 != null)
            {
               this.var_1170.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2296 == null)
         {
            this.var_2296 = findChildByTag(const_1686) as IWindowContainer;
         }
      ...
      {
         return !!this.var_783 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1170.numSelectables;
      }
