package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1373:IItemListWindow;
      
      private var var_497:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_497)
         {
            this.var_497.removeEventListener(WindowEvent.const_225,this.scrollBarEventProc);
            this.var_497.removeEventListener(WindowEvent.const_239,this.scrollBarEventProc);
            this.var_497 = null;
         }
         if(this.var_1373)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1373)
         {
            this.var_1373 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_497)
         {
            this.var_497 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_497)
            {
               this.var_497.addEventListener(WindowEvent.const_225,this.scrollBarEventProc);
               this.var_497.addEventListener(WindowEvent.const_239,this.scrollBarEventProc);
            }
         }
         return this.var_497;
      }
