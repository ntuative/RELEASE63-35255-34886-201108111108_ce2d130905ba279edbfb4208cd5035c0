package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         var _loc4_:LocalizationDefinition = this.var_994[param1];
         if(_loc4_ == null)
         {
      ...
      {
         var _loc2_:LocalizationDefinition = this.var_994[param1];
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_994[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2488);
      }
      ...
      public function printNonExistingKeys() : void
      {
         var _loc2_:* = null;
         var _loc1_:String = "";
         for each(_loc2_ in this.var_1213)
         {
            _loc1_ += _loc2_ + "\n";
         }
         Logger.log(_loc1_);
