package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2222:uint = 1;
      ...
      private var var_545:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_545 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_545.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_545.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1516 & const_1183)
         {
            if(_loc3_ == 0)
            {
               if(this.var_545.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_771 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_545.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_545.getStructByIndex(_loc8_);
